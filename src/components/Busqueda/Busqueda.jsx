...
export default function Busqueda() {
  ...
  const getProyectos = async () => {
    try {
      const response = await fetch("http://15.229.116.114:3000/proyectos", {
        method: "GET",
        headers: {
  ...
  const getFechas = async (proyecto)=>{
    try{
      const response = await fetch(`http://15.229.116.114:3000/proyectos/${proyecto.id_proyecto}/fechas`,{
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${sesion.token}`,
  ...
  const getDocumentos = async (id)=>{
    try{
      const response = await fetch(`http://15.229.116.114:3000/proyectos/${id}/documentos`,{
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${sesion.token}`,
