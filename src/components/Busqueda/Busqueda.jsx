...
export default function Busqueda() {
  ...
  const getProyectos = async () => {
    try {
      const response = await fetch("https://administrador-tesinas.duckdns.org/api/proyectos", {
        method: "GET",
        headers: {
  ...
  const getFechas = async (proyecto)=>{
    try{
      const response = await fetch(`https://administrador-tesinas.duckdns.org/api/proyectos/${proyecto.id_proyecto}/fechas`,{
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${sesion.token}`,
  ...
  const getDocumentos = async (id)=>{
    try{
      const response = await fetch(`https://administrador-tesinas.duckdns.org/api/proyectos/${id}/documentos`,{
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${sesion.token}`,
